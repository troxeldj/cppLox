...
struct Call : public Expr, public std::enable_shared_from_this<Call> {
...
struct Get : public Expr, public std::enable_shared_from_this<Get> {
...
struct Set : public Expr, public std::enable_shared_from_this<Set> {
